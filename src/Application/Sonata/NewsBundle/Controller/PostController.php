...
class PostController extends Controller
{
    ...
    {
        return $this->redirect($this->generateUrl('lzdv_post_archive'));
    }
...
//        die(var_dump($criteria));
        ...
        return new \Symfony\Component\HttpFoundation\Response( 
                $this->renderView('ApplicationSonataNewsBundle:Post:archive.html.twig', $parameters)
        );
...
//die(var_dump($asd));
    ...
    public function viewAction($slug)
    {
        ...
        $post = $this->getPostManager()->findOneBySlug($slug, $this->container->get('sonata.news.blog'));
        ...
        if ($seoPage = $this->getSeoPage()) {
            $seoPage
                ...
                ->addMeta('property', 'og:url',  $this->generateUrl('lzdv_post_view', array(
        ...
        return $this->render('ApplicationSonataNewsBundle:Post:view.html.twig', array(
            'post' => $post,
            'form' => false,
            'blog' => $this->get('sonata.news.blog')
        ));
    ...
    public function getCommentForm(PostInterface $post)
    {
        ...
        return $this->get('form.factory')->createNamed('comment', 'lzdv_post_comment', $comment);
    }
    ...
    public function addCommentAction($id)
    {
        ...
        if (!$post->isCommentable()) {
            // todo add notice
            return new RedirectResponse($this->generateUrl('lzdv_post_view', array(
